    ...
    for i in range(max_val):
        for j in range(len(coords[i])):
            ...
            if my_coords[0] < -150:
                ...
                coords[i][j] =  (my_coords[0] - 2**1, my_coords[1])
    return coords               


#Basically making the hitbox which are some invisible boxes based on coords
...
def draw_pause():
    global level, pause, menu, points, new_coords, total_shots, time_passed, time_remaining, clicked
